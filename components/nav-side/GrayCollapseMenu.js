  ...
  return (
    <div className="w-60 h-full shadow-md bg-white absolute" id="sidenavSecExample">
        ...
        <a href="#!">
          <div className="flex items-center">
            ...
            <div className="grow ml-3">
              <p className="text-sm font-semibold text-blue-600">Lisa</p>
            </div>
          </div>
        </a>
      </div>
        ...
        {Menus.map((menu, idx) => (
          <div key={idx}>
            <li className="relative">
              <Link href="/">
                <a
                  className="flex items-center text-sm py-4 px-6 h-12 overflow-hidden text-gray-700 text-ellipsis whitespace-nowrap rounded
      ...
      <div className="text-center bottom-0 absolute w-full">
        <hr className="m-0" />
        <p className="py-2 text-sm text-gray-700">lisa7h.com</p>
      </div>
    </div>
  )
}

export default GrayCollapseMenu
